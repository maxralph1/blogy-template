...
<main class="container my-5">
    <div class="row g-5">
        <div class="col-md-8">
            ...
            <article class="blog-author row mb-2">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="height: 250px;">
                            ...
                            <div class="col-md-7 p-4 d-flex flex-column position-static">
                                <h3 class="mb-0"><strong>John Doe Alexander</strong></h3>
                                <div class="mb-1 text-body-secondary">Software Engineer</div>
                                <p class="mb-auto">Geek enthusiast. Father of 50 mansions and a fat house. Always coding (every 50 hours/day). Care to join me? Bring us some cheese while we type away on the screens.</p>
                                <ul class="nav col-md-3 justify-content-between list-unstyled d-flex">
                                    <li>
                                ...
                                <a href="#" class="stretched-link text-danger mt-2">See more on author...</a>
                            </div>
                        </div>
                    </div>
                </div>
